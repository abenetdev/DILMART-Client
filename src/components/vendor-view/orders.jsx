...
function VendorOrdersView() {
  ...
  const { orderList, orderDetails } = useSelector((state) => state.vendorOrder);
  const dispatch = useDispatch();

  function handleFetchOrderDetails(getId) {
    dispatch(getOrderDetailsForVendor(getId));
  }
                  ...
                  <TableRow key={orderItem?._id}>
                    ...
                    <TableCell>
                      ...
                      >
                        ...
                        <VendorOrderDetailsView orderDetails={orderDetails} />
                      </Dialog>
                    </TableCell>
                  </TableRow>
                ))
